    ...
    Scaffold(
        ...
        if (state.isLoading) {
            ...
            Column(
                ...
                CoffeeXpMessageBanner(message = state.loadIssue.asString())
            }

        } else {
            NewCoffeeForm(innerPadding, onAction, state)
        }
    }
}

@Composable
private fun NewCoffeeForm(
...
@Preview
@Composable
private fun NewCoffeeLoadingErrorPreview() {
    CoffeeXpTheme {
        NewCoffeeScreen(
            state = NewCoffeeState(
...
@Preview
@Composable
private fun NewCoffeeErrorSavingPreview() {
    CoffeeXpTheme {
        NewCoffeeScreen(
            state = NewCoffeeState(
                coffeeNameState = TextFieldState("Ethiopian Yirgacheffe"),
